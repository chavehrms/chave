...
<aside class="aside aside-fixed">
    <div class="aside-header">
        <a href="{{ url('/home') }}" class="aside-logo">chave<span>hrms</span></a>
            ...
            <div class="collapse" id="loggedinMenu">
                <ul class="nav nav-aside mg-b-0">
                    ...
                    <li class="nav-item"><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="nav-link"><i data-feather="log-out"></i> <span>Sign Out</span></a></li>
...
<div class="content ht-100v pd-0 navbar-header-fixed">
    ...
    <footer class="footer">
        <div>
            <span>&copy; 2016 - <?php echo date('Y'); ?> Chave v1.0.0. </span>
            <span>Created by <a href="http://themepixels.me">Alfian Adhy Saputra</a></span>
        </div>
        <div>
            <nav class="nav">
